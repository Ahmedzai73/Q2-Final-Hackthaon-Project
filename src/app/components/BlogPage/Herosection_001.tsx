  ...
  return (
    <div className="relative w-full h-auto">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
        {/* Title */}
        <h1 className="text-whiteColor text-5xl font-bold leading-[56px]">Blog List</h1>
        ...
        <div className="flex space-x-2 mt-4 items-center">
          ...
          <span className="text-whiteColor text-xl font-normal hover:text-color_1"><Link href="./BlogPage">Blog</Link></span>
        </div>
      </div>
    </div>
  );
