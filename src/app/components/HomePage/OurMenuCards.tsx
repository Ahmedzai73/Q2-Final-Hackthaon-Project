...
return (
    ...
    <h1 className="Name  text-whiteColor text-xl font-bold font-inter  leading-7">{name}</h1>
    <p className="Description text-whiteColor text-sm font-normal font-inter leading-snug">{dis}</p>
    <h2 className="Price  text-color_1 text-lg font-bold font-inter leading-relaxed">{price}</h2>
    </div>
    </div>
)
