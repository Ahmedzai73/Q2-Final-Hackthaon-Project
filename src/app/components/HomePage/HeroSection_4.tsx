...
export default function HeroSection_4() {
  ...
  return (
    ...
    <div className="ExtaOrdinaryTasteAndExperienced left-[794px] top-[110px] absolute">
      <span className="text-color_1 text-5xl font-bold font-helvetica leading-[56px]">Ex</span>
      <span className="text-whiteColor text-5xl font-bold font-helvetica leading-[56px]">ta ordinary taste<br />And Experienced</span>
    </div>
    <div className="WhyChooseUs left-[794px] top-[62px] absolute text-color_1 text-[32px] font-normal font-greatVibes leading-10">Why Choose us</div>
    <div className="Group1000002063 w-[374px] h-[93px] left-[794px] top-[575px] absolute">
      <div className="Rectangle8850 w-[374px] h-[92px] left-[-0px] top-0 absolute bg-whiteColor rounded-md" />
      <div className="YearsOf left-[180px] top-[17px] absolute text-[#1e1e1e] text-xl font-normal font-inter leading-7">Years of</div>
      <div className="Rectangle8851 w-2.5 h-[93px] left-0 top-0 absolute bg-color_1 rounded-tl-md rounded-bl-md" />
      <div className="left-[51px] top-[19px] absolute text-color_1 text-5xl font-bold font-helvetica leading-[56px]">30+</div>
    ...
    <div className="IcxonBox w-[374px] h-[135px] left-[794px] top-[406px] absolute">
      <div className="Rectangle8870 w-[102px] h-[100px] left-0 top-0 absolute bg-color_1 rounded-md" />
      <div className="Rectangle8871 w-[102px] h-[100px] left-[135px] top-[1px] absolute bg-color_1 rounded-md" />
      <div className="Rectangle8872 w-[102px] h-[100px] left-[272px] top-0 absolute bg-color_1 rounded-md" />
      <div className="FastFood left-[6px] top-[109px] absolute text-whiteColor text-lg font-normal font-inter leading-relaxed">Fast Food</div>
      <div className="Lunch left-[160px] top-[109px] absolute text-whiteColor text-lg font-normal font-inter leading-relaxed">Lunch</div>
      <div className="Dinner left-[294px] top-[109px] absolute text-whiteColor text-lg font-normal font-inter leading-relaxed">Dinner</div>
    </div>
    <div className="LoremIpsumDolorSitAmetConsecteturAdipiscingElitQuisqueDiamPellentesqueBibendumNonDuiVolutpatFringillaBibendumUrnaElitAugueUrnaVitaeFeugiatPretiumDonecIdElementumUltricesMattisSedVitaeMusRisusLacusNisiEtAcDapibusSitEuVelitInConsequat w-[526px] left-[794px] top-[254px] absolute text-whiteColor text-base font-normal font-inter leading-normal">
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque diam pellentesque bibendum non dui volutpat fringilla bibendum. Urna, elit augue urna, vitae feugiat pretium donec id elementum. Ultrices mattis sed vitae mus risus. Lacus nisi, et ac dapibus sit eu velit in consequat.
    </div>
    <PiHamburgerLight className="Hamburger w-14 h-14 left-[817px] top-[428px] absolute text-whiteColor" />
    <PiCookieLight className="Cookie w-14 h-14 left-[952px] top-[429px] absolute text-whiteColor" />
    <PiWineLight  className="Wine w-14 h-14 left-[1089px] top-[428px] absolute text-whiteColor" />
  </div>
