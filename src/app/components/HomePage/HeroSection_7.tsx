...
export default function HeroSection_7() {
  return (
    <div className="main mx-auto mt-[120px] max-w-[1320px] h-[551px] ">
      ...
      <div className="Chefs text-color_1 text-[32px] font-normal font-greatVibes leading-10">Chefs</div>
      <div className="MeetOurChef mb-[56px]">
        <span className="text-color_1 text-5xl font-bold font-helvetica leading-[56px] ">Me</span>
        <span className="text-whiteColor text-5xl font-bold font-helvetica leading-[56px]">et Our Chef</span>
      </div>
      </div>
      <div className="allCardsHolder max-w-[1320px] flex justify-between">
        ...
        <div className="divcard1 main relative cursor-pointer group ">
          ...
          <div className="Rectangle8867 w-[181px] h-[67px] bg-whiteColor rounded-bl-md px-4 py-2 opacity-0 group-hover:opacity-100 transform duration-500  absolute bottom-0">
      ...
      <div className="Rectangle8868 w-[155px] h-[50px] rounded-[25px] mt-[56px] mx-auto border border-color_1 flex justify-center items-center">
      <div className="SeeMore text-whiteColor text-base font-normal font-inter leading-normal">See More</div></div>
    </div>
